...
class RecommendRequest(BaseModel):
    ...
    product_type: Optional[str] = Field(
        None, description="Optional product type / keyword filter (e.g. keyboard, mouse)"
    )
    sort_by: Optional[str] = Field(
        "ranker",
        description="Ranking strategy: 'ranker' (LambdaMART) or 'satisfaction' (review-based satisfaction score)",
    )
